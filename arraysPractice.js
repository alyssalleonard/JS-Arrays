...
users.push({
  name: 'Alyssa',
  email: 'leonard.alyssa@me.com',
  password: 'hello1',
  username: 'leonard.alyssa'
})
users.push({
  name: 'Gareth',
  email: 'leonard.garet@gmail.com',
  password: 'hello2',
  username: 'leonard.gareth'
})
...
Once you find the particular index he's located in, delete him from the array.*/
  ...
  users = users.filter(person => person.email !== 'tylermcginnis33@gmail.com')
